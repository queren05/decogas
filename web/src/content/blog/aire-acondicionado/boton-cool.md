---
title: "¿Qué significa el botón Cool en tu aire acondicionado?"
description: "Cuando vas a adquirir un aire acondicionado es fundamental que analices todas las funciones y sistemas que incluye tu electrodoméstico. De este modo,…"
category: "aire-acondicionado"
slug: "aire-acondicionado/boton-cool"
tag: "Aire acondicionado"
tagClass: "aire"
breadcrumb: "Aire acondicionado"
readingTime: 3
---
Cuando vas a adquirir un aire acondicionado es fundamental que analices todas las funciones y sistemas que incluye tu electrodoméstico. De este modo, tienes que saber que uno de los **más importantes** es la función _Cool_. Entra en Decogas y descubre qué significa el botón _Cool_ en tu aire acondicionado.

## ¿Qué significa el botón Cool en tu aire acondicionado?

El modo _Cool_, también conocido como **modo de refrigeración**, es una de las funciones más conocidas e imprescindibles de todos los sistemas de climatización. Este sistema permite enfriar la habitación hasta obtener la temperatura adecuada y mantenerla de forma homogénea y constante.
...
También podemos programar esta función para que, cuando lleguemos a casa, esta esté en una temperatura óptima y no tengamos que ajustar el aire acondicionado para conseguir una mejor climatización.
...
Ya sabes qué significa el botón _Cool_ en tu aire acondicionado, ahora viene **otro cuestión fundamental**, ¿Cómo sabes si tu aparato lo tiene? Normalmente, los propios productos incluyen el término _Cool_ en su nombre.

De no ser así, puedes **analizar la ficha técnica**, que se muestra con la descripción del producto, para confirmar si dispone de este modo o no. También puede localizarse con un icono de nieve en el mando a distancia.
...
En conclusión, el modo _cool_ es el **programa por excelencia de los aires acondicionados** y el más usado en los meses de más calor. Un buen uso de esta función nos ayuda a refrigerar las estancia, al mismo tiempo que nos permitirá ahorrar en consumo.
